...
const Header = () => {
    ...
    // pages where button should be light blue
    const lightBluePages = [];
    const isLightBlue = lightBluePages.includes(location.pathname);

    const goTo = (path) => {
        navigate(path);
        setExpanded(false); // 🔑 auto close mobile menu
    };
            ...
            >
                <Container>
                    ...
                    <Navbar.Brand onClick={() => goTo("/")}>
                        <img
                            src={theme === "blue" ? darktheemlogo : lighttheemlogo}
                            alt="Mobidudes"
                            className="logo-img"
                        />
                    </Navbar.Brand>
                    ...
                    <Navbar.Collapse className="justify-content-center">
                        <Nav className="nav-menu">
                            ...
                            <Nav.Link onClick={() => goTo("/careers")}>Careers</Nav.Link>
                            <Nav.Link onClick={() => goTo("/about")}>About Us</Nav.Link>
                            <Nav.Link onClick={() => goTo("/services")}>Services</Nav.Link>
                            <Nav.Link onClick={() => goTo("/portfolio")}>Portfolio</Nav.Link>
                            <Nav.Link onClick={() => goTo("/blog")}>Blog</Nav.Link>
                            <Nav.Link onClick={() => goTo("/contact")}>Contact Us</Nav.Link>
                        </Nav>
                    </Navbar.Collapse>
                    ...
                    <div className="header-cta d-none d-lg-block">
                        <div className="heder-end-btn">
                            <button
                                className={`btn ${isLightBlue ? "btn-lightblue" : "btn-primary-custom"}`}
